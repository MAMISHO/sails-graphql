...
module.exports = {
        ...
        errors: [
          {
            ...
            message:
              'Year Published is required and should be of type "string"',
          },
        ],
      };
    }
        ...
        errors: [
          {
            ...
            attrName: 'genre',
            message:
              "Genre is required and should be one of \"'ADVENTURE', 'COMICS', 'FANTASY', 'UNKNOWN'\"",
          },
        ],
      };
    }
        ...
        errors: [
          {
            ...
            attrName: 'genre',
            message:
              "Genre should be one of \"'ADVENTURE', 'COMICS', 'FANTASY', 'UNKNOWN'\"",
          },
        ],
      };
    }
  ...
  _updateBook: async (id, input) => {
    ...
    try {
      let result = await Book.updateOne().set(payLoad).where({
        id: id,
      ...
      result = result || {
        errors: [
          {
            code: 'I_INFO',
            message: `No Book exists with the requested Id: ${id}`,
          },
        ],
      };
      sails.log.debug(
        `BookHelper._updateBook: Book successfully updated:`,
        result
      );
      return result;
    } catch (err) {
  ...
  _deleteBook: async (id) => {
    ...
    try {
      ...
      sails.log.debug(
        `BookHelper._deleteBook: Book successfully deleted:`,
        result
      );
      return result;
    } catch (err) {
  ...
  _getBook: async (input) => {
    ...
    try {
      ...
      // Success
      sails.log.debug(
        `BookHelper._getBook: Book(s) successfully retrieved:`,
        result
      );
      return result;
    } catch (err) {
