...
module.exports = {
  ...
  _addAuthor: async (input) => {
    ...
    try {
      ...
      // Success
      sails.log.debug(
        `AuthorHelper._addAuthor: Author successfully added:`,
        result
      );
      return result;
    } catch (err) {
  ...
  _updateAuthor: async (id, input) => {
    ...
    try {
      let result = await Author.updateOne().set(payLoad).where({
        id: id,
      ...
      result = result || {
        errors: [
          {
            code: 'I_INFO',
            message: `No Author exists with the requested Id: ${id}`,
          },
        ],
      };
      sails.log.debug(
        `AuthorHelper._updateAuthor: Author successfully updated:`,
        result
      );
      return result;
    } catch (err) {
      sails.log.debug(
        'AuthorHelper._updateAuthor: Exception encountered:',
        err
      );
      return {
        errors: [
  ...
  _deleteAuthor: async (id) => {
    ...
    try {
      ...
      sails.log.debug(
        `AuthorHelper._deleteAuthor: Author successfully deleted:`,
        result
      );
      return result;
    } catch (err) {
      sails.log.debug(
        'AuthorHelper._deleteAuthor: Exception encountered:',
        err
      );
      return {
        errors: [
  ...
  _getAuthor: async (input) => {
    ...
    try {
      ...
      // Success
      sails.log.debug(
        `AuthorHelper._getAuthor: Author(s) successfully retrieved:`,
        result
      );
      return result;
    } catch (err) {
